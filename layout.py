...
def get_app_layout():
    return dbc.Container([
        ...
        # Nagłówek z neonowym gradientem
        html.H1(
            "🕵️‍♂️ VIRAL DETECTOR", 
                ...
                dbc.Row([
                    dbc.Col([
                        ...
                        dcc.Dropdown(
                            ...
                            value='Tiktok',
                            clearable=False,
                            className="text-dark" # Tekst w dropdownie musi być ciemny, żeby był czytelny
                        )
                    ], md=4),
                    ...
                    dbc.Col([
                        html.Button(
                            ...
                            id='analyze-button', 
                            n_clicks=0, 
                            className="btn btn-info w-100 fw-bold mt-4",
                            style={'boxShadow': '0 0 15px rgba(0, 242, 254, 0.4)'} # Delikatne, neonowe świecenie
                        )
                    ], md=3)
                ], className="g-3 align-items-center")
            ])
        ], className="border-info mb-4", style={'backgroundColor': '#111'}), # Mocno ciemne tło karty
        ...
        # Spinner ładowania (teraz jasnoniebieski)
        dcc.Loading(
            id="loading",
            type="cube",
            color="#00f2fe",
